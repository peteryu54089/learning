        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <form action="dbCourseSelectDeleteBatch" method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="dbCourseSelectDelete?year=${course.term_year}&sem=${course.term_sem}&num=${course.course_num}&reg=${course.memberId}"
