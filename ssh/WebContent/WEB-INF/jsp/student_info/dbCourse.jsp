        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <form action="dbCourseDeleteBatch" method="POST">
                        <c:forEach var="course" items="${courseList}">
                        <tr>
                            <td>
                                <input type="checkbox" name="checkGroup[]"
                                       value="${course.term_year},${course.term_sem},${course.class_cname},${course.course_num}"/>
                            </td>
                            ...
                            <td>${course.rcredit}</td>
                            <td>${course.rhour}</td>
                            <td>${course.remark}</td>
                            <td>
                                <a href="dbCourseDelete?year=${course.term_year}&sem=${course.term_sem}&num=${course.course_num}"
