        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <form action="dbRegDeleteBatch" method="POST">
                        <c:forEach var="student" items="${studentList}">
                        <tr>
                            <td>
                                <input type="checkbox" name="checkGroup[]"
                                       value="${student.term_year},${student.term_sem},${student.reg_no}"/>
                            </td>
                            <td>${student.term_year}</td>
                            <td>${student.term_sem}</td>
                            ...
                            <td>${student.idno}</td>
                            <td>${student.email}</td>
                            <td>${student.mobile_telno}</td>
                            <td>
                                <a href="dbRegDelete?year=${student.term_year}&sem=${student.term_sem}&reg=${student.reg_no}"
