...
<div class="container">
    ...
    <div class="">
        <div class="panel panel-primary">
            <div class="panel-heading"><span class="glyphicon glyphicon-calendar" aria-hidden="true">　</span>查詢預選課程紀錄
            </div>
    ...
    <div class="">
        <div class="panel panel-info">
            <div class="panel-heading"><span class="glyphicon glyphicon-list-alt" aria-hidden="true">　</span>預選課程紀錄
            </div>
            <div class="panel-body">
                <table class="table table-bordered" style="text-align: center">
                    ...
                    <tr>
                        ...
                        <th class="text-center" style="width: 40%">預選科目名稱</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
