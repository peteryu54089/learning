...
function view(n) {
    window.open('./tutorViewAttend?rgno=' + n);
}
...
<div class="container">
    ...
    <div class="">
        <div class="panel panel-primary">
            <div class="panel-heading"><span class="glyphicon glyphicon-calendar" aria-hidden="true">　</span>檢閱學生出缺勤紀錄
            </div>
    ...
    <div class="">
        <div class="panel panel-danger">
            <div class="panel-heading"><span class="glyphicon glyphicon-user" aria-hidden="true">　</span>出缺勤紀錄</div>
            <div class="panel-body">
