    ...
    <div class="panel-body">
        ...
        <div class="panel-body">
            <div class="panel panel-info">
                <div class="panel-heading"><span class="glyphicon glyphicon-list-alt" aria-hidden="true">　</span>出缺勤紀錄
                </div>
                <div class="panel-body">
                    <table class="table table-bordered" style="text-align: center">
                        <tr>
                    ...
                    <button class="btn btn-primary" onclick="location.href='./tutorViewCalendar?rgno=${rgno}'">出缺曠行事曆</button>
                </div>
            </div>
        </div>
    </div>
