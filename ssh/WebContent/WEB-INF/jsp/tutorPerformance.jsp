...
function view(n) {
    window.open('./tutorViewPerformance?rgno=' + n);
}
...
<div class="container">
    ...
    <div class="">
        <div class="panel panel-primary">
            <div class="panel-heading"><span class="glyphicon glyphicon-calendar" aria-hidden="true">　</span>檢閱學生多元表現
            </div>
    ...
    <div class="">
        <div class="panel panel-danger">
            <div class="panel-heading"><span class="glyphicon glyphicon-user" aria-hidden="true">　</span>多元表現</div>
            <div class="panel-body">
