<%--@elvariable id="StudentList" type="java.util.List<model.role.Student>"--%>
...
function query() {
    url = "cadreRecordBuildCadreRecord?";
    if ($("#class").val() != "")
        url += "class=" + $("#class").val() + "&";
    if ($("#rgno").val() != "")
        url += "rgno=" + $("#rgno").val() + "&";
...
function view(n) {
    window.open('./cadreRecordViewCadreRecord?rgno=' + n);
}
...
$(document).keydown(function(e){
	...
	if(code == 13 && ($("#name").val() || $("#rgno").val() || $("#class").val())){
		$("#searchButton").click();
	}
})
...
<div class="container">
    ...
    <div class="">
        <div class="panel panel-primary">
            <div class="panel-heading"><span class="glyphicon glyphicon-calendar" aria-hidden="true">　</span>檢閱學生幹部經歷
            </div>
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-2"></div>
                        <div class="col-sm-6">
                            <label for="rgno" style="font-size: large" class="col-sm-2">學號</label>
                            <div class="col-sm-10">
                                <input type="text" id="rgno" name="rgno" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row"><br/></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-10"><input id="searchButton" type="button" onclick="query()" class="btn btn-warning"
                                                          value="查詢"></div>
                        </div>
                    </div>
                </div>
