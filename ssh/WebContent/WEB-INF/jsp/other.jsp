    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading">其它紀錄</div>
                <div class="panel-body">
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                            <th colspan="8" class="info text-center">其它紀錄</th>
                        </tr>
                        <tr>
                            ...
                            <td class="col-sm-2"><c:out value="${other.birth}"></c:out></td>
                            <td class="info  col-sm-1">學期</td>
                            <td class="col-sm-2"><c:out value="-"></c:out></td>
                        </tr>
                        <tr>
                            <td class="info col-sm-1">單位名稱</td>
                            <td class="col-sm-2"><c:out value="${other.name}"></c:out></td>
                            <td class="info col-sm-1">單位職務</td>
                            <td class="col-sm-2"><c:out value="${other.unit}"></c:out></td>
                            <td class="info col-md-1">開始日期</td>
                            <td class="col-sm-2"><c:out value="${other.startTime}"></c:out></td>
                            <td class="info  col-sm-1">結束日期</td>
                            <td class="col-sm-2"><c:out value="${other.endTime}"></c:out></td>
                        </tr>
                        <tr>
                            <td class="info col-sm-1">執行時間</td>
                            <td colspan="7" class="col-sm-11"><c:out value="${other.count} hr(s)"></c:out></td>
                        </tr>
                        <tr>
                            <td class="info col-sm-1">檔案下載</td>
                            <td colspan="7" class="col-sm-11"><a
                                    href="download?file=<c:out value="${other.document}"></c:out><c:if test="${not empty manager}">&i=${other.idno}</c:if> ">點我下載</a>
                            </td>
                        </tr>
                        </thead>
                    </table>
