...
public class Autobiography {
    ...
    public Autobiography(Integer id, Integer rgno, String topic, String description, Integer main_file_id,Integer sub_file_id, Timestamp created_at, Integer term_year, Integer term_semester) {
        this.id = id;
        this.rgno = rgno;
        this.topic = topic;
