...
@WebServlet("/tutorPerformance")
public class TutorPerformanceServlet extends _BaseServlet {
...
//        	response.sendRedirect("login");
        ...
        try {
            tutor = account.getRoleDetail(Authority.RoleIndex.TUTOR);
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/tutorPerformance.jsp").forward(request, response);
    }
}
