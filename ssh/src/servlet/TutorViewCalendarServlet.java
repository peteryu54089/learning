...
@WebServlet("/tutorViewCalendar")
public class TutorViewCalendarServlet extends _BaseServlet {
...
//        	response.sendRedirect("login");
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/tutorViewCalendar.jsp").forward(request, response);
    }
