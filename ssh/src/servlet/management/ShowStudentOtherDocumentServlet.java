...
@WebServlet("/showStudentOtherDocument")
@MultipartConfig
public class ShowStudentOtherDocumentServlet extends BaseManageServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("title", "查詢學生其他文件檔案");
        request.setAttribute("MenuBarUtil", new MenuBarUtil());

        request.getRequestDispatcher("/WEB-INF/jsp/managerPage/studentOtherDocument.jsp").forward(request, response);
    }
