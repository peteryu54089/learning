...
@WebServlet("/showStudentAttend")
@MultipartConfig
public class ShowStudentAttendServlet extends BaseManageServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("title", "查詢學生出缺勤紀錄");
        request.setAttribute("MenuBarUtil", new MenuBarUtil());

        request.getRequestDispatcher("/WEB-INF/jsp/managerPage/studentAttend.jsp").forward(request, response);
    }
