...
@WebServlet("/showStudentAutoBio")
@MultipartConfig
public class ShowStudentAutoBioServlet extends BaseManageServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("title", "查詢學生自傳");
        request.setAttribute("MenuBarUtil", new MenuBarUtil());

        request.getRequestDispatcher("/WEB-INF/jsp/managerPage/studentAutoBio.jsp").forward(request, response);
    }
