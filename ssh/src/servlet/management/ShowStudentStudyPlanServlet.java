...
@WebServlet("/showStudentStudyPlan")
@MultipartConfig
public class ShowStudentStudyPlanServlet extends BaseManageServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("title", "查詢學生學習計畫檔案");
        request.setAttribute("MenuBarUtil", new MenuBarUtil());

        request.getRequestDispatcher("/WEB-INF/jsp/managerPage/studentStudyPlan.jsp").forward(request, response);
    }
