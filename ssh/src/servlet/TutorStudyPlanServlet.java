...
@WebServlet("/tutorStudyPlan")
public class TutorStudyPlanServlet extends _BaseServlet {
...
//            pageAmount = studentDao.getPageNumber(regno, "105", "2", clscode, name, null, tutor.getStaffCode(), page);
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/tutorStudyPlan.jsp").forward(request, response);
    }
}
