...
@WebServlet("/tutorAutobiography")
public class TutorAutobiographyServlet extends _BaseServlet {
...
//            pageAmount = studentDao.getPageNumber(regno, "105", "2", clscode, name, null, tutor.getStaffCode(), page);
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/tutorAutobiography.jsp").forward(request, response);
    }
}
