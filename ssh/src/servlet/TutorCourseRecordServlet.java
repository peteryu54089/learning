...
@WebServlet("/tutorCourseRecord")
public class TutorCourseRecordServlet extends _BaseServlet {
...
//        Semester sem = new Semester(105, 2);
        ...
        request.setAttribute("title", "檢閱學生課程成果");

        request.getRequestDispatcher("/WEB-INF/jsp/tutorCourseRecord.jsp").forward(request, response);
    }
}
